...
// Récupérez toutes les réservations de vols de l'utilisateur
$sql = "SELECT
    demande_reservation_vol.id_demande AS ID,
    utilisateurs.nom AS Nom_Utilisateur,
    vols.nom_vol AS Nom_Vol,
    demande_reservation_vol.date_reservation AS Date_Réservation,
    demande_reservation_vol.etat AS État
FROM
    demande_reservation_vol
INNER JOIN
    utilisateurs ON demande_reservation_vol.id_utilisateur = utilisateurs.id
INNER JOIN
    vols ON demande_reservation_vol.id_vol = vols.id;
";
...
if (isset($_GET["annuler"])) {
    ...
    $updateSql = "UPDATE demande_reservation_vol SET etat = 'annule' WHERE id_demande = ?";
...
if (isset($_GET["reserver"])) {
    ...
    $updateSql = "UPDATE demande_reservation_vol SET etat = 'en_attente' WHERE id_demande = ?";
...
<body>
    ...
    <div class="container mt-5">
        <h2 class="text-center">Mes Réservations de Vols</h2>
        <table class="table">
            <thead>
                <tr>
                    <th scope="col">#</th>
